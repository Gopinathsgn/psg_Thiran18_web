var Stats=function()
	{
		function e(e,n,t)
		{
			...
			return r.id=n,r.style.cssText=t,r
		}
		
		function n(n,t,r)
		{
			var i=e("div",n,"padding:0px;text-align:left;display:none;color:rgba(0,0,0,0)"),
			a=e("div",n+"Text","font-family:Helvetica,Arial,sans-serif;font-size:9px;font-weight:bold;line-height:15px;color:rgba(0,0,0,0)");
			a.innerHTML=n.toUpperCase(),i.appendChild(a);
			
			var o=e("div",n+"Graph","background:rgba(0,0,0,0)");
			i.appendChild(o);for(var d=0;d<74;d++)o.appendChild(e("span","","opacity:0.9;background:#000"));
			return i
			
			}
			function t(e){
				
				for(var n=l.children,t=0;t<n.length;t++)
				n[t].style.display=t===e?"block":"none";p=e
			
			}
			function r(e,n)
			{
				var t=e.appendChild(e.firstChild);
				t.style.height=Math.min(30,30-30*n)+"px"
				
			}
			var i=self.performance&&self.performance.now?self.performance.now.bind(performance):Date.now,a=i(),o=a,d=0,p=0,
