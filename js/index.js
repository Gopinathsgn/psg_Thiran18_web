    ...
    function rendererer(complete) {
        ...
        for (var ix = 0, lx = amtX; ix < lx; ix++) {
            ...
            for (var iy = 0, ly = amtY; iy < ly; iy++) {
                ...
                particle.position.x = ix * sep - ((amtX * sep) / 4);
                particle.position.z = iy * sep - ((amtY * sep) / 3);
                scene.add(particle);
            }
        }
    ...
    function update() {
        ...
        for (var ix = 0, lx = amtX; ix < lx; ix++) {
            ...
            for (var iy = 0, ly = amtY; iy < ly; iy++) {
                ...
                particle.position.y = (Math.sin((ix + count) * 0.3) * 100) + (Math.sin((iy + count) * 0.5) * 20);
